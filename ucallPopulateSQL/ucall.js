// Initialize
    ...
    function fnGetAll() {
        const query =
            'SELECT id FROM fscontact.call_log where sysdate is null limit 2000';//            'WHERE domain = $1 AND NOT deleted';
    ...
    function updateCall_log(dateTime, arrIDs) {
        ...
        const query =
            ...
            'update fscontact.call_log set sysdate=now() where id in ('+arrIDs+')';
            console.log (query);
        return Pg.query({
            text: query//,
